...
N_POSITIVES, NEG_RATIO = 120_000, 10
TCW_MIN, YTCA_MIN = 0.20, 0.65
...
def main():
    ...
    rows = [l.split("\t") for l in
            open(f"{OUT}/a3a_donor_ranking_v2.tsv").read().splitlines()[1:]]
    ...
    np.savez_compressed(f"{FEAT}/a3a_trainset_A3Awide.npz",
    ...
    log("=" * 60)
    open(f"{BASE}/flags/S1_A3AWIDE_DONE", "w").write("ok\n")
